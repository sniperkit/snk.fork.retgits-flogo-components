...
import (
	"github.com/sniperkit/snk.fork.retgits-flogo-components/command/repack/fdev/fdev/internal/github.com/TIBCOSoftware/flogo-cli/cmd/flogo/amalgomated_flag"
	"fmt"
	"os"
